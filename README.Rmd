...
The functions used to obtain the necessary information for confidence intervals in each shiny app are primarily modifications of `survfit.coxph()` from the 'survival' package, also listed on CRAN.
...
You can install the development version of shinyCox from [GitHub](https://github.com/) with:
